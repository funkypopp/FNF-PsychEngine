...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		gfDance.frames = Paths.getSparrowAtlas('hitthatshit');
		gfDance.animation.addByPrefix('idle', 'hitthatshit', 12, true);
		...
		if(!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 5:
					deleteCoolText();
				case 6:
					createCoolText(['Kind of associated', 'with'], -40);
				case 8:
					addMoreText('FNF: SHARP', -40);
					ngSpr.visible = true;
				case 9:
					deleteCoolText();
					ngSpr.visible = false;
