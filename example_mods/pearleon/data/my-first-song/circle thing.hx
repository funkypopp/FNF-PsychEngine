...
function createCircle(dataNum:Int, char:String) {
	...
	var cirSprite = new FlxSprite().makeGraphic(diameter, diameter, FlxColor.TRANSPARENT);
	...
	var style:LineStyle = {
		thickness: thickness,
		color: noteColors[dataNum]
	};
	var maxRadius = radius;
	FlxTween.num(1, maxRadius, 1.1, { ease: FlxEase.expoOut },
		(r) -> {
